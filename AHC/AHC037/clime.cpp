...
int32_t main() {
    ...
    while (end - start < TIME_LIMIT / 2) {
        cnt++;
        int idx1 = uniform_int_distribution<int>(0, n / 2 - 1)(engine);
        int idx2 = uniform_int_distribution<int>(0, n / 2 - 1)(engine);
        // int idx3 = uniform_int_distribution<int>(n / 2, n - 1)(engine);
        // int idx4 = uniform_int_distribution<int>(n / 2, n - 1)(engine);
        // int idx1 = 0, idx2 = 0;
        int idx3 = 0, idx4 = 0;
